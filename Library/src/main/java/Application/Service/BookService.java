...
public class BookService {
    ...
    public Book addBook(Book book) {
        if(this.bookDAO.getBookByIsbn(book.getIsbn()) != null) return null;
        else return this.bookDAO.insertBook(book);
    }
    /**
    ...
    public List<Book> getAllAvailableBooks() {
        List<Book> availablebooks = this.bookDAO.getBooksWithBookCountOverZero();

        if(availablebooks == null) return null;
